...
export function AboutIntro() {
  return (
    <section className="flex w-full flex-col gap-[125px] px-10 pb-[125px] pt-10">
      <Image
      ...
      <div className="flex flex-col gap-10 sm:flex-row sm:items-start sm:justify-between">
        <Image
          ...
          height={532}
          aria-hidden
          className="h-auto w-full max-w-[280px] shrink-0 sm:w-[532px] sm:max-w-[532px]"
        />

        <div className="flex flex-col gap-6 text-2xl leading-[1.6] text-pretty sm:max-w-[755px]">
          <p>
